...
const localizedContent = {
  en: {
    nav: ['Exo-Core', 'About', 'Contact'],
    heroEyebrow: 'Exoskeleton technologies', heroTitle: '<span class="hero-line">Supporting your work,</span><em class="hero-line">securing your life.</em>', heroIntro: 'Wearable assistance designed around lifting, carrying, bending, and walking tasks.', discover: 'Discover ExoTechHK <span>↓</span>',
    detailsKicker: 'EXO-CORE', detailsTitle: 'Unrivaled Facts', detailMeta: ['ASSISTANCE','WEIGHT','OPERATION','MEASURED RESULT','TORQUE','MOVEMENT','ASSISTED JOINTS','ACTUATION','ASSISTANCE MODES','MATERIALS','SPEED','BATTERY','PROTECTION','CHARGING','CONTROL'], detailTitles: ['28<small>kg</small>','3.8<small>kg</small>','~4.5<small>h</small>','Max 30<small>%</small>','60<small>Nm</small>','Lifting · Lowering · Walking','Hip Joint · Lower Back','Active Powered','Followed Lifting · Large Lifting · Walking + Lifting','Carbon Fiber<br>Aerospace-Grade Aluminium<br>ABS Plastic','2000<small>deg/s</small>','90<small>Wh</small>','IP54','~1.5<small>h</small>','On-Exoskeleton Control'], detailDescriptions: ['Lifting Assistance','System Weight','Typical Operation Time','Body Stress Reduction','Combined Peak Assistance Torque','Designed to Assist Movement','Targeted Assistance','Actuation Type','Three assistance modes','Engineered Materials','Peak Assisted Speed','Battery Capacity','Equivalent Water / Dust Protection','USB Type-C PD 3.0','Integrated Control Panel'], factsNote: '',
    aboutKicker: 'Company / ExoTechHK', aboutTitle: 'About Us', aboutBody: 'ExoTechHK Limited is a robotics startup from The Chinese University of Hong Kong focusing on the development of exoskeleton solutions. With a team of professor and researchers, we are dedicated in developing innovative robotic technologies and pushing the application of exoskeletons in the industrial sector. Our goal is to enhance the strength and mobility of workers and reduce the risk of work-related injuries.', contactKicker: 'Contact', contactTitle: 'Contact Us', formIntro: 'Feel free to contact us.', formFields: ['Name','Email*','Message'], send: 'Send', contactInfo: 'Contact information', contactLabels: ['Address','Phone'], address: 'Unit 1031, 10/F, Building 19W,<br>No. 19 Science Park West Avenue,<br>Hong Kong Science Park,<br>Pak Shek Kok, N.T., Hong Kong', footerTagline: 'Supporting your work,<br>securing your life.', footerLabels: ['Products','Contact','Location'], location: 'Hong Kong Science Park<br>Pak Shek Kok, Hong Kong', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: 'Initializing exoskeleton'
  },
  'zh-HK': {
    nav: ['Exo-Core', '關於我們', '聯絡'],
    heroEyebrow: 'EXOSKELETON TECHNOLOGIES', heroTitle: '<span class="hero-line">助力工作，</span><em class="hero-line">守護生活。</em>', heroIntro: '穿戴式助力系統，支援抬升、搬運、彎腰及行走工作。', discover: '探索 EXOTECHK <span>↓</span>',
    detailsKicker: 'EXO-CORE', detailsTitle: '卓越規格', detailMeta: ['助力','重量','運作時間','實測結果','扭矩','動作','輔助關節','驅動方式','助力模式','材料','速度','電池','防護','充電','控制'], detailTitles: ['28<small>公斤</small>','3.8<small>公斤</small>','~4.5<small>小時</small>','最高 30<small>%</small>','60<small>Nm</small>','抬升 · 下降 · 行走','髖關節<br>腰背','主動動力','跟隨抬升 · 大力抬升 · 行走 + 抬升','碳纖維<br>航太級鋁材<br>ABS 塑膠','2000<small>度/秒</small>','90<small>Wh</small>','IP54','~1.5<small>小時</small>','外骨骼機身控制'], detailDescriptions: ['抬升助力','系統重量','典型運作時間','身體壓力降低 · 肌電量測','綜合峰值助力扭矩','動作助力設計','針對性助力','驅動類型','三種助力模式','工程材料','峰值輔助速度','電池容量','同等防水／防塵保護','USB Type-C PD 3.0','整合式控制面板'], factsNote: '',
    aboutKicker: '公司 / ExoTechHK', aboutTitle: '關於我們', aboutBody: 'ExoTechHK Limited 是源自香港中文大學的機器人初創公司，專注於外骨骼解決方案的研發。我們的團隊由教授及研究人員組成，致力開發創新機器人技術，並推動外骨骼在工業領域的應用。我們的目標是提升工人的力量與活動能力，並降低工作相關傷害的風險。', contactKicker: '聯絡我們', contactTitle: '聯絡我們', formIntro: '歡迎與我們聯絡。', formFields: ['姓名','電郵*','訊息'], send: '傳送', contactInfo: '聯絡資料', contactLabels: ['地址','電話'], address: '香港特別行政區 新界 白石角<br>香港科學園 19W大樓 10樓 1031室', footerTagline: '助力工作，<br>守護生活。', footerLabels: ['產品','聯絡','地點'], location: '香港科學園<br>香港白石角', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: '正在初始化外骨骼'
  }
};
