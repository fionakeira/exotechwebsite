...
const localizedContent = {
  en: {
    ...
    heroEyebrow: 'Exoskeleton technologies', heroTitle: '<span class="hero-line">Wearable Power</span><em class="hero-line">for Physical Work</em>', heroIntro: 'Exo-Core reduces lower-back strain during lifting, carrying, and repetitive manual tasks.', heroCta: 'Request a Demo', discover: 'Discover ExoTechHK <span>↓</span>',
    ...
    aboutKicker: 'Company / ExoTechHK', aboutTitle: 'About Us', aboutBody: 'ExoTechHK develops wearable assistance solutions for physically demanding work. Our mission is to reduce worker fatigue, support safer work, and make practical exoskeleton technology accessible. We combine robotics engineering, human-centered design, and field testing to create lightweight, reliable tools for industrial and daily work environments.', contactKicker: 'Demo / Pilot', contactTitle: 'Request a Demo', formFields: ['Name','Email*','Message'], send: 'Discuss a Pilot', contactInfo: 'Contact information', contactLabels: ['Address','Phone'], address: 'Unit 1031, 10/F, Building 19W,<br>No. 19 Science Park West Avenue,<br>Hong Kong Science Park,<br>Pak Shek Kok, N.T., Hong Kong', footerTagline: 'Supporting your work<br>Securing your life', footerLabels: ['Product','Contact','Location'], location: 'Hong Kong Science Park<br>Pak Shek Kok, Hong Kong', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: 'Initializing exoskeleton'
  },
  'zh-HK': {
    nav: ['Exo-Core', '關於我們', '預約示範'],
    heroEyebrow: 'EXOSKELETON TECHNOLOGIES', heroTitle: '<span class="hero-line">穿戴式動力</span><em class="hero-line">應對體力工作</em>', heroIntro: 'Exo-Core 在抬升、搬運及重複人工作業時減輕腰背負擔。', heroCta: '預約示範', discover: '探索 EXOTECHK <span>↓</span>',
    ...
    aboutKicker: '公司 / ExoTechHK', aboutTitle: '關於我們', aboutBody: 'ExoTechHK 研發適用於高體力需求工作的穿戴式助力方案。我們的使命是減輕工作疲勞、支持更安全的工作方式，並讓實用的外骨骼技術更易普及。我們結合機器人工程、以人為本的設計及實地測試，開發適用於工業及日常工作環境的輕巧可靠工具。', contactKicker: '示範 / 試點', contactTitle: '預約示範', formFields: ['姓名','電郵*','訊息'], send: '洽談試點', contactInfo: '聯絡資料', contactLabels: ['地址','電話'], address: '香港特別行政區 新界 白石角<br>香港科學園 19W大樓 10樓 1031室', footerTagline: '助力工作<br>守護生活', footerLabels: ['產品','聯絡','地點'], location: '香港科學園<br>香港白石角', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: '正在初始化外骨骼'
  }
};
...
function applyLanguage(language) {
  ...
  setHTMLList('.mini-nav a', copy.nav); setHTML('.hero .eyebrow', copy.heroEyebrow); setHTML('.hero h1', copy.heroTitle); setHTML('.hero .intro', copy.heroIntro); setHTML('.hero-cta', copy.heroCta); setHTML('.scroll-cue', copy.discover);
