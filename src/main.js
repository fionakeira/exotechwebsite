...
const localizedContent = {
  en: {
    ...
    detailsKicker: 'EXO-CORE', detailsTitle: 'Unrivaled Facts', detailMeta: ['ASSISTANCE','WEIGHT','OPERATION','MEASURED RESULT','TORQUE','MOVEMENT','ASSISTED JOINTS','ACTUATION','ASSISTANCE MODES','MATERIALS','SPEED','BATTERY','PROTECTION','CHARGING','CONTROL'], detailTitles: ['28<small>kg</small>','3.8<small>kg</small>','~4.5<small>h</small>','Max 30<small>%</small>','60<small>Nm</small>','Lifting · Lowering · Walking','Hip Joint<br>Lower Back','Active Powered','Followed Lifting · Large Lifting · Walking + Lifting','Carbon Fiber<br>Aerospace-Grade Aluminium<br>ABS Plastic','2000<small>deg/s</small>','90<small>Wh</small>','IP54','~1.5<small>h</small>','On-Exoskeleton Control'], detailDescriptions: ['Lifting Assistance','System Weight','Typical Operation Time','Body Stress Reduction','Combined Peak Assistance Torque','Designed to Assist Movement','Targeted Assistance','Actuation Type','Three assistance modes','Engineered Materials','Peak Assisted Speed','Battery Capacity','Equivalent Water / Dust Protection','USB Type-C PD 3.0 · @ 60W','Integrated Control Panel'], factsNote: '',
