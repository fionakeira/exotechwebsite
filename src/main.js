...
const localizedContent = {
  ...
  'zh-HK': {
    ...
    aboutKicker: '公司 / ExoTechHK', aboutTitle: '關於我們', aboutBody: 'ExoTechHK 研發適用於高體力需求工作的穿戴式助力方案。我們的使命是減輕工作疲勞、支持更安全的工作方式，並讓實用的外骨骼技術更易普及。我們結合機器人工程、以人為本的設計及實地測試，開發適用於工業及日常工作環境的輕巧可靠工具。', contactKicker: '示範 / 試點', contactTitle: '預約示範', formIntro: '預約示範或洽談試點。', formFields: ['姓名','電郵*','訊息'], send: '洽談試點', contactInfo: '聯絡資料', contactLabels: ['地址','電話'], address: '香港特別行政區 新界 白石角<br>香港科學園 19W大樓 10樓 1031室', footerTagline: '助力工作，<br>守護生活。', footerLabels: ['產品','聯絡','地點'], location: '香港科學園<br>香港白石角', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: '正在初始化外骨骼'
  }
};
