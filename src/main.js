...
const localizedContent = {
  en: {
    ...
    heroEyebrow: 'Exoskeleton technologies', heroTitle: '<span class="hero-line">Supporting your work</span><em class="hero-line">Securing your life</em>', heroIntro: 'Lightweight wearable assistance for industrial work', heroCta: 'Request a Demo', discover: 'Discover ExoTechHK <span>↓</span>',
    detailsKicker: 'EXO-CORE', detailsTitle: 'Product facts', detailMeta: ['LIFTING ASSISTANCE','SYSTEM WEIGHT','OPERATING TIME','MEASURED RESULT','TORQUE','BUILT FOR','ASSISTED AREAS','POWER','ASSISTANCE MODES','MATERIALS','SPEED','BATTERY','PROTECTION','CHARGING','CONTROL'], detailTitles: ['28<small>kg</small>','3.8<small>kg</small>','~4.5<small>h</small>','30<small>%</small>','60<small>Nm</small>','Lifting · Lowering · Walking','Hip Joint ·<br>Lower Back','Active Powered','Followed Lifting · Large Lifting · Walking + Lifting','Carbon Fiber<br>Aerospace-Grade Aluminium<br>ABS Plastic','2000<small>deg/s</small>','90<small>Wh</small>','IP54','~1.5<small>h</small>','On-Exoskeleton Control'], detailDescriptions: ['Assistance','System weight','Operating time','Measured body stress reduction','Combined Peak Assistance Torque','For repetitive, physically demanding work.','Targeted assistance','Powered assistance','Three assistance modes','For industrial workplaces.','Peak Assisted Speed','Battery Capacity','Equivalent Water / Dust Protection','USB Type-C PD 3.0','Integrated Control Panel'], factsNote: '',
    aboutKicker: 'Company / ExoTechHK', aboutTitle: 'About Us', aboutBody: 'ExoTechHK develops wearable assistance solutions for physically demanding work. Our mission is to reduce worker fatigue, support safer work, and make practical exoskeleton technology accessible. We combine robotics engineering, human-centered design, and field testing to create lightweight, reliable tools for industrial and daily work environments.', contactKicker: 'Demo / Pilot', contactTitle: 'Request a Demo', formIntro: 'Send us a message', formFields: ['Name','Email*','Message'], send: 'Send', contactInfo: 'Contact information', contactLabels: ['Address','Phone'], address: 'Unit 1031, 10/F, Building 19W,<br>No. 19 Science Park West Avenue,<br>Hong Kong Science Park,<br>Pak Shek Kok, N.T., Hong Kong', footerTagline: 'Supporting your work<br>Securing your life', footerLabels: ['Product','Contact','Location'], location: 'Hong Kong Science Park<br>Pak Shek Kok, Hong Kong', copyright: 'Copyright © 2025 ExoTechHK - All Rights Reserved.', loader: 'Initializing exoskeleton'
  },
  'zh-HK': {
