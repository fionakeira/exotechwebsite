...
const localizedContent = {
  en: {
    ...
    heroEyebrow: 'Exoskeleton technologies', heroTitle: '<span class="hero-line">Supporting your work</span><em class="hero-line">Securing your life</em>', heroIntro: 'Wearable assistance designed around lifting and walking tasks.', discover: 'Discover ExoTechHK <span>↓</span>',
  ...
  'zh-HK': {
    ...
    heroEyebrow: 'EXOSKELETON TECHNOLOGIES', heroTitle: '<span class="hero-line">助力工作，</span><em class="hero-line">守護生活。</em>', heroIntro: '穿戴式助力系統，支援抬升及行走工作。', discover: '探索 EXOTECHK <span>↓</span>',
